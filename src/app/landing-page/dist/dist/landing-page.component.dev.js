...
function () {
  ...
  LandingPageComponent = __decorate([core_1.Component({
    ...
    standalone: true,
    imports: [header_component_1.HeaderComponent, start_page_component_1.StartPageComponent, about_me_component_1.AboutMeComponent, my_skills_component_1.MySkillsComponent, my_portfolio_component_1.MyPortfolioComponent, contact_me_component_1.ContactMeComponent, footer_component_1.FooterComponent],
