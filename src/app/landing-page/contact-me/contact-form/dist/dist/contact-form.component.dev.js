...
function () {
    ...
    if (ngForm.submitted && ngForm.form.valid) {
      this.http.post(this.post.endPoint, this.post.body(this.contactData)).subscribe({
        ...
        complete: function complete() {
          return console.info('send post complete');
        }
      });
  ...
  ContactFormComponent = __decorate([core_1.Component({
    selector: 'app-contact-form',
    standalone: true,
    imports: [forms_1.FormsModule, common_1.CommonModule, router_1.RouterLink, router_1.RouterLinkActive, router_1.RouterOutlet],
